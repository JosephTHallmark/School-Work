...
//TODO
//you could separate the data structure of the reference file from the processing core
//
...
namespace PCA_with_number_files {
    ...
    static class DataStructure {
        ...
        //static List<double> variance = new List<double>();        *//PCA needs data that has been centered on its mean
        //static List<List<adder>> CoVar = new List<List<adder>>(); *//meaning that the new mean of each dimension is zero
